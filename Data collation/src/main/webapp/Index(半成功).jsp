                    ...
                    for (var i = 0; i < jsonData.length; i++) {
                        ...
                        if (row && row[0] && 
                            (String(row[0]).includes('新北市') ||
                             ...
                             String(row[0]).includes('桃園市') || 
                             String(row[0]).includes('臺中市') ||
                             String(row[0]).includes('臺南市') || 
                             String(row[0]).includes('高雄市') ||
                             String(row[0]).includes('宜蘭縣') ||
                             String(row[0]).includes('新竹縣') ||
                             String(row[0]).includes('苗栗縣') ||
                             String(row[0]).includes('彰化縣') ||
                             String(row[0]).includes('南投縣') ||
                             String(row[0]).includes('雲林縣') ||
                             String(row[0]).includes('嘉義縣') ||
                             String(row[0]).includes('屏東縣') ||
                             String(row[0]).includes('臺東縣') ||
                             String(row[0]).includes('花蓮縣') ||
                             String(row[0]).includes('澎湖縣') ||
                             String(row[0]).includes('基隆市') ||
                             String(row[0]).includes('新竹市') ||
                             String(row[0]).includes('嘉義市') ||
                             String(row[0]).includes('金門縣') ||
                             String(row[0]).includes('連江縣'))) {
                            cityRowIndex = i;
